...
const Designer = () => {
  ...
  const handleWhatsClick = () => {
    window.open("https://wa.me/9578619732", "_blank");
  };
      ...
      <div>
        <div className={`${Styles.back}`}>
          <div className={`${Styles.head}`}>
            <span>SAY HELLO! LET'S CONNECT</span>
          </div>
        </div>
        <span
          className={`${Styles.text} my-3 d-flex align-item-center justify-content-center text-start`}
        >
        ...
        <div className="d-flex align-items-center justify-content-start">
          <div className={`${Styles.in} d-flex flex-column `}>
            ...
            >
              <span className="me-3"> mohanraj130298@gmail.com</span>
