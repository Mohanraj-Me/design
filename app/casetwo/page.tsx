...
const casetwo = () => {
  ...
  const handleOpenFigma = () => {
    window.open(
      "https://www.figma.com/proto/RwjjZuZ2zk7XrACCI2lDND/Project?type=design&node-id=9-2&t=mNd8s5gww4tSrclv-1&scaling=scale-down&page-id=0%3A1&starting-point-node-id=9%3A2&mode=design",
      "_blank"
    );
  };
